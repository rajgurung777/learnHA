...
def two_fold_segmentation(A, b1, b2, ytuple, size_of_input_variables, ep=0.01):
    """
    ...
    :param ep: Maximal error toleration value.
    ...
    lowDifference = 0.01   # I can also set 0.1
    ...
    for i in range(0, len(ytuple)):
        ...
        while True:
            ...
            while high < max_id:  # moving high further.
                ...
                if diff_val >= ep:  # high difference.    This will detect boundary points
                    position_diffValue.append([high, relDiff_backward, relDiff_foward])
                    high += 1
...
def segmented_trajectories(clfs, res, position):
    """
    ...
    :return: The following data structures
        ...
        res: the modified res, after deleting the last segment per trajectory.
